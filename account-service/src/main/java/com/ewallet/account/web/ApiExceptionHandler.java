...
public class ApiExceptionHandler {
    ...
    private HttpStatus status(String code) {
        return switch (code) {
            ...
            case "RECIPIENT_NOT_FOUND", "ACCOUNT_NOT_FOUND", "TRANSACTION_NOT_FOUND", "RISK_EVALUATION_NOT_FOUND" -> HttpStatus.NOT_FOUND;
            ...
            case "CURRENCY_MISMATCH", "INVALID_AMOUNT", "SELF_TRANSFER", "IDEMPOTENCY_KEY_REQUIRED", "IDEMPOTENCY_PAYLOAD_MISMATCH",
                "RISK_EVALUATION_REQUIRED", "RISK_EVALUATION_EXPIRED", "RISK_TRANSACTION_NOT_FOUND" -> HttpStatus.UNPROCESSABLE_ENTITY;
