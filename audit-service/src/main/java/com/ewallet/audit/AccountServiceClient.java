...
public class AccountServiceClient {
    ...
    public ResponseEntity<String> getAudit(HttpHeaders inboundHeaders) {
        ...
        return restTemplate.exchange(baseUrl + "/api/audit", HttpMethod.GET, new HttpEntity<>(headers), String.class);
    }
